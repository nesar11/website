                        ...
                        <div className="contact-info mr-50 mr-xs-0  mr-md-0">
                            <div className="single-contact-info d-flex align-items-center">
                                ...
                                <div className="contact-info-text mt-10">
                                    ...
                                    <h5><a href="https://wa.me/+6011-1133-5693">+6011-1133-5693</a></h5>
                                </div>
                            </div>
                            <div className="single-contact-info d-flex align-items-center">
                                <div className="contact-info-icon">
                                ...
                                <div className="contact-info-text mt-10">
                                    ...
                                    <h5><a href="mailto:info@Al-EbreizGlobal.com">info@Al-EbreizGlobal.com</a> </h5>
                                </div>
                            </div>
                            <div className="single-contact-info d-flex align-items-center">
                                <div className="contact-info-icon">
                                ...
                                <div className="contact-info-text mt-10">
                                    ...
                                    <h5><a href="#">Suite 11, 12, 13, 14<br/>Level 2, Resource Centre <br /> Technology Park Malaysia <br /> 57000 Bukit Jalil, Kuala Lumpur
