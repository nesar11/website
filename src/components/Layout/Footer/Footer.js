               ...
               <div className="row">
                     ...
                     <div className="col-lg-3 col-sm-6">
                        <div className="widget widget-contact mb-30">
                           ...
                           <ul>
                                 <li className="pb-10">Suite 11, 12, 13, 14<br/>Level 2, Resource Centre <br /> Technology Park Malaysia <br /> 57000 Bukit Jalil, Kuala Lumpur
...
Malaysia </li>
                                 ...
                                 <li><img src="assets/img/icon/footer-icon-2.png" className="img-fluid" alt="icon-img"/><a href="tel:011335693">+6011-1133-5693</a></li>
                           </ul>
                        </div>
                     </div>
                     <div className="col-lg-3 col-sm-6">
