               ...
               <div className="row">
                     ...
                     <div className="col-lg-3 col-sm-6">
                        <div className="widget widget-contact mb-30">
                           ...
                           <ul>
                                 <li className="pb-10">Level 2, Resource Centre <br/>New York, USA</li>
                                 ...
                                 <li><img src="assets/img/icon/footer-icon-2.png" className="img-fluid" alt="icon-img"/><a href="tel:926668880000"> +603 888 0000</a></li>
                           </ul>
                        </div>
                     </div>
                     <div className="col-lg-3 col-sm-6">
